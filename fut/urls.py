...
def __updateUrls__(urls, cl, site_config):
        ...
        path = '{0}{1}game/fifa18/'.format(urls['fut_host'], rc['main']['directHttpServiceDestination'])
        path_auth = '{0}/iframe/fut18{1}'.format(urls['main_site'], rc['main']['httpServiceDestination'])
        for i in services:
            if i == 'authentication':
...
def urls(platform, cl=None, site_config=None):
    ...
    urls = {
        ...
        'fut_question':          'https://www.easports.com/iframe/fut18/p/ut/game/fifa18/phishing/question',  # add timestamp
        'fut_validate':          'https://www.easports.com/iframe/fut18/p/ut/game/fifa18/phishing/validate',
        'fut_auth':              'https://www.easports.com/iframe/fut18/p/ut/auth',
        'fut_captcha_img':       'https://www.easports.com/iframe/fut18/p/ut/captcha/img',  # add timestamp
        'fut_captcha_validate':  'https://www.easports.com/iframe/fut18/p/ut/captcha/validate',
