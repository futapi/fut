...
def urls(platform, cl=None):
    ...
    urls = {
        ...
        'fut_config':            'http://www.easports.com/iframe/fut15/bundles/futweb/web/flash/xml/site_config.xml',  # add timestamp
        'fut_home':              'http://www.easports.com/uk/fifa/football-club/ultimate-team',
        'fut':                   {},  # it's updated dynamicly (based on fut_config)
        'fut_question':          'http://www.easports.com/iframe/fut15/p/ut/game/fifa15/phishing/question',  # add timestamp
        'fut_validate':          'http://www.easports.com/iframe/fut15/p/ut/game/fifa15/phishing/validate',
        'fut_captcha_img':       'http://www.easports.com/iframe/fut15/p/ut/captcha/img',  # add timestamp
        'fut_captcha_validate':  'http://www.easports.com/iframe/fut15/p/ut/captcha/validate',
        ...
        'shards':                'http://www.easports.com/iframe/fut15/p/ut/shards',  # add timestamp
        'acc_info':              'http://www.easports.com/iframe/fut15/p/ut/game/fifa15/user/accountinfo',
